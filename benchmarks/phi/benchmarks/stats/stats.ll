...
body0:
  ...
  %tmp.binop24 = sub i64 %num, %imm_store23
  br label %while.cond11
while.cond11:
  %imm_store26 = add i64 0, 0
  %_27 = icmp sgt i64 %tmp.binop24, %imm_store26
  br i1 %_27, label %while.body2, label %while.exit5
while.body2:
  %cur2 = phi i64 [ %prev16, %while.cond11 ], [ %prev40, %while.fillback4 ]
  ...
  %curNode12 = phi %struct.linkedNums* [ null, %while.cond11 ], [ %prevNode42, %while.fillback4 ]
  %tmp.binop29 = mul i64 %prev10, %prev10
  %tmp.binop30 = sdiv i64 %tmp.binop29, %seed6
  %imm_store31 = add i64 2, 0
  %tmp.binop32 = sdiv i64 %seed6, %imm_store31
  %tmp.binop33 = mul i64 %tmp.binop30, %tmp.binop32
  %imm_store34 = add i64 1, 0
  %cur35 = add i64 %tmp.binop33, %imm_store34
  %imm_store36 = add i64 1000000000, 0
  %tmp.binop37 = sdiv i64 %cur35, %imm_store36
  %imm_store38 = add i64 1000000000, 0
  %tmp.binop39 = mul i64 %tmp.binop37, %imm_store38
  ...
  %imm_store47 = add i64 1, 0
  %num48 = sub i64 %num8, %imm_store47
  br label %while.cond23
while.cond23:
  %imm_store50 = add i64 0, 0
  %_51 = icmp sgt i64 %num48, %imm_store50
  br i1 %_51, label %while.fillback4, label %while.exit5
while.fillback4:
  br label %while.body2
while.exit5:
  %cur3 = phi i64 [ %prev16, %while.cond11 ], [ %prev40, %while.cond23 ]
  %prevNode5 = phi %struct.linkedNums* [ %prevNode18, %while.cond11 ], [ %prevNode42, %while.cond23 ]
  %seed7 = phi i64 [ %seed, %while.cond11 ], [ %seed6, %while.cond23 ]
  %num9 = phi i64 [ %tmp.binop24, %while.cond11 ], [ %num48, %while.cond23 ]
  %prev11 = phi i64 [ %prev16, %while.cond11 ], [ %prev40, %while.cond23 ]
  %curNode13 = phi %struct.linkedNums* [ null, %while.cond11 ], [ %prevNode42, %while.cond23 ]
  br label %exit
exit:
  %return_reg54 = phi %struct.linkedNums* [ %curNode13, %while.exit5 ]
  ret %struct.linkedNums* %return_reg54
}
...
while.body2:
  %sum1 = phi i64 [ %sum10, %while.cond11 ], [ %sum20, %while.fillback4 ]
  %num3 = phi i64 [ %num11, %while.cond11 ], [ %num17, %while.fillback4 ]
  %nums7 = phi %struct.linkedNums* [ %nums, %while.cond11 ], [ %nums22, %while.fillback4 ]
  %imm_store16 = add i64 1, 0
  %num17 = add i64 %num3, %imm_store16
...
while.fillback4:
  br label %while.body2
while.exit5:
  %sum2 = phi i64 [ %sum10, %while.cond11 ], [ %sum20, %while.cond23 ]
  %num4 = phi i64 [ %num11, %while.cond11 ], [ %num17, %while.cond23 ]
  %nums6 = phi %struct.linkedNums* [ %nums, %while.cond11 ], [ %nums22, %while.cond23 ]
  br label %if.cond6
if.cond6:
  %imm_store28 = add i64 0, 0
  %_29 = icmp ne i64 %num4, %imm_store28
...
then.exit8:
  br label %if.exit9
if.exit9:
  %mean5 = phi i64 [ %mean12, %if.cond6 ], [ %mean31, %then.exit8 ]
  br label %exit
exit:
  %return_reg34 = phi i64 [ %mean5, %if.exit9 ]
...
body0:
  %prev11 = add i64 1, 0
  %result12 = add i64 0, 0
  br label %while.cond11
while.cond11:
  %_14 = icmp slt i64 %result12, %num
  br i1 %_14, label %while.body2, label %while.exit5
while.body2:
  %prev1 = phi i64 [ %prev11, %while.cond11 ], [ %guess18, %while.fillback4 ]
  %num3 = phi i64 [ %num, %while.cond11 ], [ %num3, %while.fillback4 ]
  %prev5 = phi i64 [ %prev11, %while.cond11 ], [ %prev1, %while.fillback4 ]
  %result7 = phi i64 [ %result12, %while.cond11 ], [ %result16, %while.fillback4 ]
  %result16 = mul i64 %prev1, %prev1
  %imm_store17 = add i64 1, 0
  %guess18 = add i64 %prev1, %imm_store17
  br label %while.cond23
while.cond23:
...
while.fillback4:
  br label %while.body2
while.exit5:
  %guess2 = phi i64 [ %prev11, %while.cond11 ], [ %guess18, %while.cond23 ]
  %num4 = phi i64 [ %num, %while.cond11 ], [ %num3, %while.cond23 ]
  %prev6 = phi i64 [ %prev11, %while.cond11 ], [ %prev1, %while.cond23 ]
  %result8 = phi i64 [ %result12, %while.cond11 ], [ %result16, %while.cond23 ]
  br label %exit
exit:
  %return_reg23 = phi i64 [ %prev6, %while.exit5 ]
...
while.fillback4:
  br label %while.body2
while.exit5:
  %nums1 = phi %struct.linkedNums* [ %nums, %while.cond11 ], [ %nums12, %while.cond23 ]
  br label %exit
exit:
  ret void
}
...
while.body2:
  %min3 = phi i64 [ %min15, %while.cond11 ], [ %min1, %while.fillback20 ]
  %max7 = phi i64 [ %max16, %while.cond11 ], [ %max5, %while.fillback20 ]
  %nums10 = phi %struct.linkedNums* [ %nums, %while.cond11 ], [ %nums53, %while.fillback20 ]
  %_14 = phi i1 [ %first17, %while.cond11 ], [ %first12, %while.fillback20 ]
  br label %if.cond3
if.cond3:
...
if.cond7:
  ...
  br i1 %_33, label %then.body8, label %else.body10
then.body8:
...
if.exit18:
  ...
  %first12 = phi i1 [ %first27, %then.exit5 ], [ %_14, %else.exit17 ]
...
while.fillback20:
  br label %while.body2
while.exit21:
  %min2 = phi i64 [ %min15, %while.cond11 ], [ %min1, %while.cond219 ]
  %max6 = phi i64 [ %max16, %while.cond11 ], [ %max5, %while.cond219 ]
  %nums11 = phi %struct.linkedNums* [ %nums, %while.cond11 ], [ %nums53, %while.cond219 ]
  %first13 = phi i1 [ %first17, %while.cond11 ], [ %first12, %while.cond219 ]
...
body0:
  ...
  br label %exit
exit:
  %return_reg17 = phi i64 [ %imm_store16, %body0 ]
