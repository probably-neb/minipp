...
if.cond1:
  ...
  br i1 %_8, label %then.body2, label %if.exit3
then.body2:
  br label %exit
if.exit3:
...
if.exit3:
  ...
  %tmp.binop13 = add i64 %imm_store9, %aufrufen_size12
  br label %exit
exit:
...
if.cond1:
  ...
  %_6 = icmp eq i64 %index, %imm_store5
...
if.exit3:
  ...
  %tmp.binop15 = sub i64 %index, %imm_store14
...
if.cond1:
  ...
  %_26 = icmp sle i64 %aufrufen_size24, %imm_store25
  br i1 %_26, label %then.body2, label %if.exit3
then.body2:
  br label %exit
if.exit3:
  %imm_store30 = add i64 0, 0
  %aufrufen_get31 = call i64 (%struct.node*, i64) @get(%struct.node* %list, i64 %imm_store30)
  %aufrufen_size32 = call i64 (%struct.node*) @size(%struct.node* %list)
  %imm_store33 = add i64 1, 0
  %tmp.binop34 = sub i64 %aufrufen_size32, %imm_store33
  ...
  %pivot38 = sdiv i64 %tmp.binop36, %imm_store37
  %i39 = add i64 0, 0
  br label %while.cond14
while.cond14:
...
while.body5:
  ...
  %i12 = phi i64 [ %i39, %while.cond14 ], [ %i58, %while.fillback13 ]
...
while.exit14:
  ...
  %temp5 = phi %struct.node* [ %list, %while.cond14 ], [ %temp56, %while.cond212 ]
  %pivot9 = phi i64 [ %pivot38, %while.cond14 ], [ %pivot8, %while.cond212 ]
  %i11 = phi i64 [ %i39, %while.cond14 ], [ %i58, %while.cond212 ]
...
body0:
  ...
  %imm_store4 = add i64 999, 0
  %tmp.unop5 = sub i64 0, %imm_store4
  %_6 = getelementptr [ 5 x i8 ], [ 5 x i8 ]* @.println, i1 0, i32 0
  %_7 = call i32 (i8*, ...) @printf(i8* %_6, i64 %tmp.unop5)
  call void (%struct.node*) @printList(%struct.node* %list)
  %imm_store9 = add i64 999, 0
  %tmp.unop10 = sub i64 0, %imm_store9
  %_11 = getelementptr [ 5 x i8 ], [ 5 x i8 ]* @.println, i1 0, i32 0
  %_12 = call i32 (i8*, ...) @printf(i8* %_11, i64 %tmp.unop10)
  call void (%struct.node*) @printList(%struct.node* %list)
  %imm_store14 = add i64 999, 0
  %tmp.unop15 = sub i64 0, %imm_store14
  %_16 = getelementptr [ 5 x i8 ], [ 5 x i8 ]* @.println, i1 0, i32 0
  %_17 = call i32 (i8*, ...) @printf(i8* %_16, i64 %tmp.unop15)
  br label %exit
exit:
  %return_reg18 = phi %struct.node* [ null, %body0 ]
  ret %struct.node* %return_reg18
}
...
if.cond1:
  ...
  br i1 %_9, label %then.body2, label %if.exit12
then.body2:
  br label %if.cond3
if.cond3:
  ...
  br i1 %_14, label %then.body4, label %if.exit5
then.body4:
...
if.cond6:
  ...
  %_24 = icmp eq i64 %aufrufen_treesearch22, %imm_store23
  br i1 %_24, label %then.body7, label %if.exit8
then.body7:
...
if.cond9:
  ...
  %_33 = icmp eq i64 %aufrufen_treesearch31, %imm_store32
...
if.exit12:
  ...
  br label %exit
exit:
  %return_reg17 = phi i64 [ %imm_store16, %then.body4 ], [ %imm_store26, %then.body7 ], [ %imm_store35, %then.body10 ], [ %imm_store37, %else.body11 ], [ %imm_store39, %if.exit12 ]
...
if.cond1:
  %_9 = icmp ne %struct.tnode* %root, null
  br i1 %_9, label %then.body2, label %if.exit9
then.body2:
  br label %if.cond3
if.cond3:
  %root.data_auf12 = getelementptr %struct.tnode, %struct.tnode* %root, i1 0, i32 0
...
then.body7:
  ...
  br label %exit
if.exit9:
  %imm_store32 = add i64 0, 0
  br label %exit
exit:
  %return_reg17 = phi i64 [ %imm_store16, %then.body4 ], [ %aufrufen_bintreesearch26, %then.body7 ], [ %aufrufen_bintreesearch30, %else.body8 ], [ %imm_store32, %if.exit9 ]
  ret i64 %return_reg17
}
...
while.exit5:
  ...
  %i4 = phi i64 [ %i9, %while.cond11 ], [ %i17, %while.cond23 ]
  %list6 = phi %struct.node* [ %list, %while.cond11 ], [ %list5, %while.cond23 ]
  br label %exit
exit:
  %return_reg23 = phi %struct.tnode* [ %root2, %while.exit5 ]
  ret %struct.tnode* %return_reg23
}
...
body0:
  ...
  %imm_store3 = add i64 999, 0
  %tmp.unop4 = sub i64 0, %imm_store3
  %_5 = getelementptr [ 5 x i8 ], [ 5 x i8 ]* @.println, i1 0, i32 0
  %_6 = call i32 (i8*, ...) @printf(i8* %_5, i64 %tmp.unop4)
  ...
  %imm_store16 = add i64 999, 0
  %tmp.unop17 = sub i64 0, %imm_store16
  %_18 = getelementptr [ 5 x i8 ], [ 5 x i8 ]* @.println, i1 0, i32 0
  %_19 = call i32 (i8*, ...) @printf(i8* %_18, i64 %tmp.unop17)
  call void (%struct.node*) @freeList(%struct.node* %postList14)
  %imm_store21 = add i64 0, 0
  %aufrufen_treesearch22 = call i64 (%struct.tnode*, i64) @treesearch(%struct.tnode* %root1, i64 %imm_store21)
  %_23 = getelementptr [ 5 x i8 ], [ 5 x i8 ]* @.println, i1 0, i32 0
  %_24 = call i32 (i8*, ...) @printf(i8* %_23, i64 %aufrufen_treesearch22)
  %imm_store25 = add i64 999, 0
  %tmp.unop26 = sub i64 0, %imm_store25
  %_27 = getelementptr [ 5 x i8 ], [ 5 x i8 ]* @.println, i1 0, i32 0
  %_28 = call i32 (i8*, ...) @printf(i8* %_27, i64 %tmp.unop26)
  %imm_store29 = add i64 10, 0
  %aufrufen_treesearch30 = call i64 (%struct.tnode*, i64) @treesearch(%struct.tnode* %root1, i64 %imm_store29)
  %_31 = getelementptr [ 5 x i8 ], [ 5 x i8 ]* @.println, i1 0, i32 0
  %_32 = call i32 (i8*, ...) @printf(i8* %_31, i64 %aufrufen_treesearch30)
  %imm_store33 = add i64 999, 0
  %tmp.unop34 = sub i64 0, %imm_store33
  %_35 = getelementptr [ 5 x i8 ], [ 5 x i8 ]* @.println, i1 0, i32 0
  %_36 = call i32 (i8*, ...) @printf(i8* %_35, i64 %tmp.unop34)
  %imm_store37 = add i64 2, 0
  %tmp.unop38 = sub i64 0, %imm_store37
  %aufrufen_treesearch39 = call i64 (%struct.tnode*, i64) @treesearch(%struct.tnode* %root1, i64 %tmp.unop38)
  %_40 = getelementptr [ 5 x i8 ], [ 5 x i8 ]* @.println, i1 0, i32 0
  %_41 = call i32 (i8*, ...) @printf(i8* %_40, i64 %aufrufen_treesearch39)
  %imm_store42 = add i64 999, 0
  %tmp.unop43 = sub i64 0, %imm_store42
  %_44 = getelementptr [ 5 x i8 ], [ 5 x i8 ]* @.println, i1 0, i32 0
  %_45 = call i32 (i8*, ...) @printf(i8* %_44, i64 %tmp.unop43)
  %imm_store46 = add i64 2, 0
  %aufrufen_treesearch47 = call i64 (%struct.tnode*, i64) @treesearch(%struct.tnode* %root1, i64 %imm_store46)
  %_48 = getelementptr [ 5 x i8 ], [ 5 x i8 ]* @.println, i1 0, i32 0
  %_49 = call i32 (i8*, ...) @printf(i8* %_48, i64 %aufrufen_treesearch47)
  %imm_store50 = add i64 999, 0
  %tmp.unop51 = sub i64 0, %imm_store50
  %_52 = getelementptr [ 5 x i8 ], [ 5 x i8 ]* @.println, i1 0, i32 0
  %_53 = call i32 (i8*, ...) @printf(i8* %_52, i64 %tmp.unop51)
  %imm_store54 = add i64 3, 0
  %aufrufen_treesearch55 = call i64 (%struct.tnode*, i64) @treesearch(%struct.tnode* %root1, i64 %imm_store54)
  %_56 = getelementptr [ 5 x i8 ], [ 5 x i8 ]* @.println, i1 0, i32 0
  %_57 = call i32 (i8*, ...) @printf(i8* %_56, i64 %aufrufen_treesearch55)
  %imm_store58 = add i64 999, 0
  %tmp.unop59 = sub i64 0, %imm_store58
  %_60 = getelementptr [ 5 x i8 ], [ 5 x i8 ]* @.println, i1 0, i32 0
  %_61 = call i32 (i8*, ...) @printf(i8* %_60, i64 %tmp.unop59)
  %imm_store62 = add i64 9, 0
  %aufrufen_treesearch63 = call i64 (%struct.tnode*, i64) @treesearch(%struct.tnode* %root1, i64 %imm_store62)
  %_64 = getelementptr [ 5 x i8 ], [ 5 x i8 ]* @.println, i1 0, i32 0
  %_65 = call i32 (i8*, ...) @printf(i8* %_64, i64 %aufrufen_treesearch63)
  %imm_store66 = add i64 999, 0
  %tmp.unop67 = sub i64 0, %imm_store66
  %_68 = getelementptr [ 5 x i8 ], [ 5 x i8 ]* @.println, i1 0, i32 0
  %_69 = call i32 (i8*, ...) @printf(i8* %_68, i64 %tmp.unop67)
  %imm_store70 = add i64 1, 0
  %aufrufen_treesearch71 = call i64 (%struct.tnode*, i64) @treesearch(%struct.tnode* %root1, i64 %imm_store70)
  %_72 = getelementptr [ 5 x i8 ], [ 5 x i8 ]* @.println, i1 0, i32 0
  %_73 = call i32 (i8*, ...) @printf(i8* %_72, i64 %aufrufen_treesearch71)
  %imm_store74 = add i64 999, 0
  %tmp.unop75 = sub i64 0, %imm_store74
  %_76 = getelementptr [ 5 x i8 ], [ 5 x i8 ]* @.println, i1 0, i32 0
  %_77 = call i32 (i8*, ...) @printf(i8* %_76, i64 %tmp.unop75)
  %imm_store78 = add i64 0, 0
  %aufrufen_bintreesearch79 = call i64 (%struct.tnode*, i64) @bintreesearch(%struct.tnode* %root1, i64 %imm_store78)
  %_80 = getelementptr [ 5 x i8 ], [ 5 x i8 ]* @.println, i1 0, i32 0
  %_81 = call i32 (i8*, ...) @printf(i8* %_80, i64 %aufrufen_bintreesearch79)
  %imm_store82 = add i64 999, 0
  %tmp.unop83 = sub i64 0, %imm_store82
  %_84 = getelementptr [ 5 x i8 ], [ 5 x i8 ]* @.println, i1 0, i32 0
  %_85 = call i32 (i8*, ...) @printf(i8* %_84, i64 %tmp.unop83)
  %imm_store86 = add i64 10, 0
  %aufrufen_bintreesearch87 = call i64 (%struct.tnode*, i64) @bintreesearch(%struct.tnode* %root1, i64 %imm_store86)
  %_88 = getelementptr [ 5 x i8 ], [ 5 x i8 ]* @.println, i1 0, i32 0
  %_89 = call i32 (i8*, ...) @printf(i8* %_88, i64 %aufrufen_bintreesearch87)
  %imm_store90 = add i64 999, 0
  %tmp.unop91 = sub i64 0, %imm_store90
  %_92 = getelementptr [ 5 x i8 ], [ 5 x i8 ]* @.println, i1 0, i32 0
  %_93 = call i32 (i8*, ...) @printf(i8* %_92, i64 %tmp.unop91)
  %imm_store94 = add i64 2, 0
  %tmp.unop95 = sub i64 0, %imm_store94
  %aufrufen_bintreesearch96 = call i64 (%struct.tnode*, i64) @bintreesearch(%struct.tnode* %root1, i64 %tmp.unop95)
  %_97 = getelementptr [ 5 x i8 ], [ 5 x i8 ]* @.println, i1 0, i32 0
  %_98 = call i32 (i8*, ...) @printf(i8* %_97, i64 %aufrufen_bintreesearch96)
  %imm_store99 = add i64 999, 0
  %tmp.unop100 = sub i64 0, %imm_store99
  %_101 = getelementptr [ 5 x i8 ], [ 5 x i8 ]* @.println, i1 0, i32 0
  %_102 = call i32 (i8*, ...) @printf(i8* %_101, i64 %tmp.unop100)
  %imm_store103 = add i64 2, 0
  %aufrufen_bintreesearch104 = call i64 (%struct.tnode*, i64) @bintreesearch(%struct.tnode* %root1, i64 %imm_store103)
  %_105 = getelementptr [ 5 x i8 ], [ 5 x i8 ]* @.println, i1 0, i32 0
  %_106 = call i32 (i8*, ...) @printf(i8* %_105, i64 %aufrufen_bintreesearch104)
  %imm_store107 = add i64 999, 0
  %tmp.unop108 = sub i64 0, %imm_store107
  %_109 = getelementptr [ 5 x i8 ], [ 5 x i8 ]* @.println, i1 0, i32 0
  %_110 = call i32 (i8*, ...) @printf(i8* %_109, i64 %tmp.unop108)
  %imm_store111 = add i64 3, 0
  %aufrufen_bintreesearch112 = call i64 (%struct.tnode*, i64) @bintreesearch(%struct.tnode* %root1, i64 %imm_store111)
  %_113 = getelementptr [ 5 x i8 ], [ 5 x i8 ]* @.println, i1 0, i32 0
  %_114 = call i32 (i8*, ...) @printf(i8* %_113, i64 %aufrufen_bintreesearch112)
  %imm_store115 = add i64 999, 0
  %tmp.unop116 = sub i64 0, %imm_store115
  %_117 = getelementptr [ 5 x i8 ], [ 5 x i8 ]* @.println, i1 0, i32 0
  %_118 = call i32 (i8*, ...) @printf(i8* %_117, i64 %tmp.unop116)
  %imm_store119 = add i64 9, 0
  %aufrufen_bintreesearch120 = call i64 (%struct.tnode*, i64) @bintreesearch(%struct.tnode* %root1, i64 %imm_store119)
  %_121 = getelementptr [ 5 x i8 ], [ 5 x i8 ]* @.println, i1 0, i32 0
  %_122 = call i32 (i8*, ...) @printf(i8* %_121, i64 %aufrufen_bintreesearch120)
  %imm_store123 = add i64 999, 0
  %tmp.unop124 = sub i64 0, %imm_store123
  %_125 = getelementptr [ 5 x i8 ], [ 5 x i8 ]* @.println, i1 0, i32 0
  %_126 = call i32 (i8*, ...) @printf(i8* %_125, i64 %tmp.unop124)
  %imm_store127 = add i64 1, 0
  %aufrufen_bintreesearch128 = call i64 (%struct.tnode*, i64) @bintreesearch(%struct.tnode* %root1, i64 %imm_store127)
  %_129 = getelementptr [ 5 x i8 ], [ 5 x i8 ]* @.println, i1 0, i32 0
  %_130 = call i32 (i8*, ...) @printf(i8* %_129, i64 %aufrufen_bintreesearch128)
  %imm_store131 = add i64 999, 0
  %tmp.unop132 = sub i64 0, %imm_store131
  %_133 = getelementptr [ 5 x i8 ], [ 5 x i8 ]* @.println, i1 0, i32 0
  %_134 = call i32 (i8*, ...) @printf(i8* %_133, i64 %tmp.unop132)
...
while.cond11:
  ...
  %_17 = icmp slt i64 %i14, %imm_store16
  br i1 %_17, label %while.body2, label %while.exit5
while.body2:
  %element1 = phi i64 [ %element43, %while.cond11 ], [ %element22, %while.fillback4 ]
  %copyList12 = phi %struct.node* [ null, %while.cond11 ], [ %copyList124, %while.fillback4 ]
  %sortedList5 = phi %struct.node* [ %sortedList45, %while.cond11 ], [ %sortedList26, %while.fillback4 ]
  %i6 = phi i64 [ %i14, %while.cond11 ], [ %i30, %while.fillback4 ]
  %copyList28 = phi %struct.node* [ null, %while.cond11 ], [ %copyList225, %while.fillback4 ]
  ...
  %i30 = add i64 %i6, %imm_store29
  br label %while.cond23
while.cond23:
  %imm_store32 = add i64 10, 0
  %_33 = icmp slt i64 %i30, %imm_store32
  br i1 %_33, label %while.fillback4, label %while.exit5
while.fillback4:
  br label %while.body2
while.exit5:
  %element0 = phi i64 [ %element43, %while.cond11 ], [ %element22, %while.cond23 ]
  %copyList13 = phi %struct.node* [ null, %while.cond11 ], [ %copyList124, %while.cond23 ]
  %sortedList4 = phi %struct.node* [ %sortedList45, %while.cond11 ], [ %sortedList26, %while.cond23 ]
  %i7 = phi i64 [ %i14, %while.cond11 ], [ %i30, %while.cond23 ]
  %copyList29 = phi %struct.node* [ null, %while.cond11 ], [ %copyList225, %while.cond23 ]
  %myList11 = phi %struct.node* [ null, %while.cond11 ], [ %myList23, %while.cond23 ]
  call void (%struct.node*) @freeList(%struct.node* %myList11)
  call void (%struct.node*) @freeList(%struct.node* %copyList13)
  call void (%struct.node*) @freeList(%struct.node* %copyList29)
  %imm_store39 = add i64 0, 0
  br label %exit
exit:
  %return_reg40 = phi i64 [ %imm_store39, %while.exit5 ]
  ret i64 %return_reg40
}
