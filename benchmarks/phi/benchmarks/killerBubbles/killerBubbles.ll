...
entry:
  ...
  br label %body0
body0:
  %swapped20 = add i64 1, 0
  br label %while.cond11
while.cond11:
  %imm_store22 = add i64 1, 0
  %_23 = icmp eq i64 %swapped20, %imm_store22
  br i1 %_23, label %while.body2, label %while.exit14
while.body2:
  %currNode4 = phi %struct.Node* [ %currNode68, %while.cond11 ], [ %currNode2, %while.fillback13 ]
  %swap9 = phi i64 [ %swap70, %while.cond11 ], [ %swap7, %while.fillback13 ]
  %swapped11 = phi i64 [ %swapped20, %while.cond11 ], [ %swapped13, %while.fillback13 ]
  %currNode19 = phi %struct.Node* [ %head, %while.cond11 ], [ %head17, %while.fillback13 ]
  %swapped25 = add i64 0, 0
...
while.body4:
  ...
  %swap6 = phi i64 [ %swap9, %while.cond13 ], [ %swap10, %while.fillback10 ]
  %swapped12 = phi i64 [ %swapped25, %while.cond13 ], [ %swapped15, %while.fillback10 ]
...
if.cond5:
  ...
  %_36 = icmp sgt i64 %aufrufen_compare34, %imm_store35
...
then.body6:
  ...
  %swapped50 = add i64 1, 0
  br label %then.exit7
then.exit7:
  br label %if.exit8
if.exit8:
  %currNode5 = phi %struct.Node* [ %currNode1, %if.cond5 ], [ %currNode1, %then.exit7 ]
  %swap10 = phi i64 [ %swap6, %if.cond5 ], [ %swap39, %then.exit7 ]
  %swapped15 = phi i64 [ %swapped12, %if.cond5 ], [ %swapped50, %then.exit7 ]
...
while.exit11:
  %currNode2 = phi %struct.Node* [ %currNode19, %while.cond13 ], [ %currNode54, %while.cond29 ]
  %swap7 = phi i64 [ %swap9, %while.cond13 ], [ %swap10, %while.cond29 ]
  %swapped13 = phi i64 [ %swapped25, %while.cond13 ], [ %swapped15, %while.cond29 ]
  %head17 = phi %struct.Node* [ %currNode19, %while.cond13 ], [ %head16, %while.cond29 ]
  br label %while.cond212
while.cond212:
  %imm_store62 = add i64 1, 0
  %_63 = icmp eq i64 %swapped13, %imm_store62
  br i1 %_63, label %while.fillback13, label %while.exit14
while.fillback13:
  br label %while.body2
while.exit14:
  %currNode3 = phi %struct.Node* [ %currNode68, %while.cond11 ], [ %currNode2, %while.cond212 ]
  %swap8 = phi i64 [ %swap70, %while.cond11 ], [ %swap7, %while.cond212 ]
  %swapped14 = phi i64 [ %swapped20, %while.cond11 ], [ %swapped13, %while.cond212 ]
  %head18 = phi %struct.Node* [ %head, %while.cond11 ], [ %head17, %while.cond212 ]
  br label %exit
exit:
  ret void
}
...
while.body2:
  ...
  %toFree6 = phi %struct.Node* [ %toFree32, %while.cond11 ], [ %toFree1, %while.fillback4 ]
...
while.fillback4:
  br label %while.body2
while.exit5:
  %currNode2 = phi %struct.Node* [ %currNode8, %while.cond11 ], [ %currNode23, %while.cond23 ]
  %head4 = phi %struct.Node* [ %head, %while.cond11 ], [ %head3, %while.cond23 ]
  %toFree5 = phi %struct.Node* [ %toFree32, %while.cond11 ], [ %toFree1, %while.cond23 ]
  br label %exit
exit:
  ret void
}
...
entry:
  ...
  br label %body0
body0:
  %imm_store15 = add i64 666, 0
  store i64 %imm_store15, i64* @swapped
...
if.cond1:
  ...
  %_23 = icmp sle i64 %numNodes20, %imm_store22
...
then.body2:
  ...
  %tmp.unop30 = sub i64 0, %imm_store29
  br label %exit
if.exit3:
  %imm_store33 = add i64 1000, 0
  %counter34 = mul i64 %numNodes20, %imm_store33
  ...
  %imm_store43 = add i64 1, 0
  %counter44 = sub i64 %counter34, %imm_store43
  br label %while.cond14
while.cond14:
  %imm_store46 = add i64 0, 0
  %_47 = icmp sgt i64 %counter44, %imm_store46
  br i1 %_47, label %while.body5, label %while.exit8
while.body5:
  %currNode1 = phi %struct.Node* [ %currNode71, %while.cond14 ], [ %previous50, %while.fillback7 ]
  ...
  %counter60 = sub i64 %counter11, %imm_store59
  br label %while.cond26
while.cond26:
  %imm_store62 = add i64 0, 0
  %_63 = icmp sgt i64 %counter60, %imm_store62
  br i1 %_63, label %while.fillback7, label %while.exit8
while.fillback7:
  br label %while.body5
while.exit8:
  %currNode0 = phi %struct.Node* [ %currNode71, %while.cond14 ], [ %previous50, %while.cond26 ]
  %previous3 = phi %struct.Node* [ %previous36, %while.cond14 ], [ %previous50, %while.cond26 ]
  %head9 = phi %struct.Node* [ %previous36, %while.cond14 ], [ %head8, %while.cond26 ]
  %counter10 = phi i64 [ %counter44, %while.cond14 ], [ %counter60, %while.cond26 ]
  ...
  br label %exit
exit:
  %return_reg31 = phi i64 [ %tmp.unop30, %then.body2 ], [ %imm_store68, %while.exit8 ]
