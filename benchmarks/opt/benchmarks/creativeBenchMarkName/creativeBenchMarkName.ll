...
while.body2:
  %i1 = phi i64 [ 0, %while.cond11 ], [ %i26, %while.fillback4 ]
...
while.cond23:
  %_29 = icmp slt i64 %i26, 5
  br i1 %_29, label %while.fillback4, label %exit
while.fillback4:
  br label %while.body2
exit:
  ret i64 %product20
...
body0:
  ...
  %tmp.binop16 = sdiv i64 %sum14, 2
  %result17 = sub i64 %product13, %tmp.binop16
  br label %while.cond11
while.cond11:
  br label %while.body2
while.body2:
  %i0 = phi i64 [ 0, %while.cond11 ], [ %i25, %while.fillback4 ]
  %list2 = phi %struct.node* [ %list12, %while.cond11 ], [ %list2, %while.fillback4 ]
  %bigProduct6 = phi i64 [ 0, %while.cond11 ], [ %bigProduct23, %while.fillback4 ]
  ...
  br label %while.cond23
while.cond23:
  %_28 = icmp slt i64 %i25, 2
  br i1 %_28, label %while.fillback4, label %while.exit5
while.fillback4:
  br label %while.body2
while.exit5:
  %_31 = getelementptr [ 5 x i8 ], [ 5 x i8 ]* @.println, i1 0, i32 0
  %_32 = call i32 (i8*, ...) @printf(i8* %_31, i64 %bigProduct23)
  br label %while.cond16
while.cond16:
  %_35 = icmp ne i64 %bigProduct23, 0
  br i1 %_35, label %while.body7, label %while.exit10
while.body7:
  %bigProduct4 = phi i64 [ %bigProduct23, %while.cond16 ], [ %bigProduct38, %while.fillback9 ]
  %bigProduct38 = sub i64 %bigProduct4, 1
  br label %while.cond28
while.cond28:
  %_41 = icmp ne i64 %bigProduct38, 0
  br i1 %_41, label %while.fillback9, label %while.exit10
while.fillback9:
  br label %while.body7
while.exit10:
  %bigProduct5 = phi i64 [ %bigProduct23, %while.cond16 ], [ %bigProduct38, %while.cond28 ]
