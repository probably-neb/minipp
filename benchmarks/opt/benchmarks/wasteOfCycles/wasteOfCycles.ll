...
entry:
  ...
  br label %if.cond1
if.cond1:
  %_14 = icmp sle i64 %n, 0
  br i1 %_14, label %then.body2, label %while.cond14
then.body2:
  br label %exit
while.cond14:
  %tmp.binop21 = mul i64 %n, %n
  %_22 = icmp slt i64 0, %tmp.binop21
  br i1 %_22, label %while.body5, label %while.exit8
while.body5:
  %n4 = phi i64 [ %n, %while.cond14 ], [ %n4, %while.fillback7 ]
  %i8 = phi i64 [ 0, %while.cond14 ], [ %i28, %while.fillback7 ]
  %j24 = add i64 %i8, %n4
...
while.exit8:
  ...
  %tmp.binop35 = sub i64 %n5, 1
  %aufrufen_function36 = call i64 (i64) @function(i64 %tmp.binop35)
  br label %exit
exit:
  %return_reg17 = phi i64 [ 0, %then.body2 ], [ %aufrufen_function36, %while.exit8 ]
...
body0:
  ...
  %_9 = call i32 (i8*, ...) @printf(i8* %_8, i64 0)
  br label %exit
exit:
  ret i64 0
}
