...
if.exit3:
  ...
  %tmp.binop13 = add i64 1, %aufrufen_length12
  br label %exit
exit:
...
while.cond11:
  ...
  %_17 = icmp sgt i64 %load_global15, 0
...
while.cond28:
  ...
  %_53 = icmp sgt i64 %aufrufen_length51, 0
  br i1 %_53, label %while.fillback9, label %while.exit10
while.fillback9:
  br label %while.body7
while.exit10:
  %sum5 = phi i64 [ 0, %while.cond16 ], [ %sum45, %while.cond28 ]
